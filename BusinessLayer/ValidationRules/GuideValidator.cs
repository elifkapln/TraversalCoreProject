...
namespace BusinessLayer.ValidationRules
{
    public class GuideValidator : AbstractValidator<Guide>
    {
        public GuideValidator()
        {
            ...
            RuleFor(x => x.Name).MaximumLength(30).WithMessage("lütfen 30 karakterden kısa bir ad giriniz");
            RuleFor(x => x.Name).MinimumLength(8).WithMessage("lütfen 8 karakterden uzun bir ad giriniz");
        }
    }
}